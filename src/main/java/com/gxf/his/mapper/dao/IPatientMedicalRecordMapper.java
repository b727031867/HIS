 ...
 * 电子病历接口
 */
public interface IPatientMedicalRecordMapper extends PatientMedicalRecordMapper {
    ...
    @Insert({
            ...
            "tgjc, diagnosis, ",
            "zlyj, doctor_id, patient_id,ticket_id,content, ",
            "create_datetime)",
            ...
            "#{zlyj,jdbcType=VARCHAR}, #{doctorId,jdbcType=BIGINT}, #{patientId,jdbcType=BIGINT}, #{ticketId,jdbcType=BIGINT},#{content,jdbcType=VARCHAR}, ",
    ...
    @Select({
            ...
            "*",
            "from entity_patient_medical_record",
            "where ticket_id = #{ticketId,jdbcType=BIGINT}  LIMIT 1"
    })
    @Results({
            @Result(column = "medical_record_id", property = "medicalRecordId", jdbcType = JdbcType.BIGINT, id = true),
            @Result(column = "narrator", property = "narrator", jdbcType = JdbcType.VARCHAR),
    ...
    PatientMedicalRecord selectPatientMedicalRecordByTicketId(Long ticketId);
