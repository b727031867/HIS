...
public interface DrugStoreBatchesMapper {
    ...
    @Insert({
        ...
        "#{contactPersonName,jdbcType=VARCHAR}, #{inventoryBatchesNumber,jdbcType=VARCHAR}, ",
    ...
    @Results({
        ...
        @Result(column="inventory_batches_number", property="inventoryBatchesNumber", jdbcType=JdbcType.VARCHAR),
    ...
    @Update({
        ...
        "set supplier_name = #{supplierName,jdbcType=VARCHAR},",
          ...
          "inventory_batches_number = #{inventoryBatchesNumber,jdbcType=VARCHAR},",
