...
public interface OrderItemMapper {
    ...
    @Insert({
        ...
        "order_item_total, doctor_advice,ticket_resource_id,check_item_id)",
        "values (#{orderItemId,jdbcType=BIGINT}, #{orderId,jdbcType=BIGINT}, ",
        "#{drugId,jdbcType=BIGINT}, #{drugQuantities,jdbcType=INTEGER}, ",
        "#{orderItemTotal,jdbcType=DECIMAL}, #{doctorAdvice,jdbcType=VARCHAR},#{ticketResourceId,jdbcType=BIGINT},#{checkItemId,jdbcType=BIGINT})"
    })
